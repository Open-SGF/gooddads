...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::0icFG5xKzqSSsQrb',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::CWRUEndi5qqjW9sT',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/users/([^/]++)(?|(*:25)|/edit(*:37)|(*:44))|/reset\\-password/([^/]++)(*:77)|/verify\\-email/([^/]++)/([^/]++)(*:116))/?$}sDu',
    ),
    3 => 
    array (
      25 => 
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Auth\\UserRegistrationController@create',
        'controller' => 'App\\Http\\Controllers\\Auth\\UserRegistrationController@create',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Auth\\UserRegistrationController@store',
        'controller' => 'App\\Http\\Controllers\\Auth\\UserRegistrationController@store',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\UsersController@list',
        'controller' => 'App\\Http\\Controllers\\UsersController@list',
        'as' => 'users.list',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\UsersController@destroyMultiple',
        'controller' => 'App\\Http\\Controllers\\UsersController@destroyMultiple',
        'as' => 'users.destroyMultiple',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\CurriculumController@list',
        'controller' => 'App\\Http\\Controllers\\CurriculumController@list',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\ClassesController@list',
        'controller' => 'App\\Http\\Controllers\\ClassesController@list',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\ReportsController@list',
        'controller' => 'App\\Http\\Controllers\\ReportsController@list',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
