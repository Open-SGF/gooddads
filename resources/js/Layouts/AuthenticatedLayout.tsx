...
const ToastNotification = () => {
	...
	// Get the current toast data
	const toast = props.toast as
		| {
	...
	// Use effect to handle visibility and tracking of new toasts
	useEffect(() => {
		// If there's toast data and it's a new toast (different message)
		if (toast && (!toastId || toastId !== toast.message)) {
			// Reset visibility for new toast
			setVisible(true)

			// Track this toast to avoid showing it multiple times
	...
	return (
		<ToastProvider>
			<div className="min-h-screen dark:bg-gray-900 flex flex-row">
				{/* Toast notification that directly uses page props */}
				<ToastNotification />
